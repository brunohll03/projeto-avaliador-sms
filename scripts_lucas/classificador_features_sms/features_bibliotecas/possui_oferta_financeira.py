...
Exemplo positivo: Seu crédito de R$ 20.000 foi pré-aprovado. Clique aqui para contratar agora.
Contraexemplo: Seu dinheiro foi recebido.
"""

HIPOTESE = 'A mensagem oferece crédito, empréstimo, financiamento ou oportunidade de investimento ao destinatário.'
EXPLICACAO = 'Distingue oferta comercial de simples comprovante ou aviso de parcela paga.'


def medir(sms: str) -> dict:
    """Retorna escore, limiar e hipótese usados na decisão."""
    from .classificador import obter_classificador
    return obter_classificador().medir_feature('possui_oferta_financeira', sms)
